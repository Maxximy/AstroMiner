...
- [x] **INFRA-01**: ECS world bootstraps with hybrid bridge layer (ECS simulation + GameObject rendering/UI/audio)
- [x] **INFRA-02**: WebGL build runs at 60 FPS with 100 asteroids and 1000 minerals active
- [x] **INFRA-03**: Object pooling system for asteroids, minerals, damage popups, and particles
- [x] **INFRA-04**: Game state machine manages Playing, Collecting, GameOver, and Upgrading states
- [x] **INFRA-05**: InputBridge writes mouse world position to ECS singleton each frame
- [x] **INFRA-06**: Large number formatting utility (K/M/B/T) used across all credit displays

### Mining

- [x] **MINE-01**: Mining circle follows mouse cursor on the gameplay plane
- [x] **MINE-02**: Mining circle deals tick-based AoE damage to all asteroids within radius
- [x] **MINE-03**: Damage rate and damage amount are configurable and upgradeable
- [x] **MINE-04**: Mining circle radius is upgradeable via tech tree
- [x] **MINE-05**: Mining circle has visual feedback (cyan emissive ring with bloom glow)

### Asteroids

- [x] **ASTR-01**: Asteroids spawn at top of screen and drift downward
- [x] **ASTR-02**: Each asteroid has HP determined by its resource tier
- [x] **ASTR-03**: Asteroids have 3D PBR models with per-resource-type visual appearance
- [x] **ASTR-04**: Asteroids rotate (spin) while drifting for visual interest
- [x] **ASTR-05**: Asteroids that reach the bottom of the screen are destroyed (missed)
...
- [x] **VISL-01**: Realistic space aesthetic with starfield skybox
- [x] **VISL-02**: URP post-processing: bloom, tonemapping
...
- [x] **VISL-05**: Ship visual at bottom of screen (stationary)
...
| MINE-03 | Phase 2 | Complete |
| MINE-04 | Phase 2 | Complete |
| MINE-05 | Phase 2 | Complete |
| ASTR-01 | Phase 2 | Complete |
| ASTR-02 | Phase 2 | Complete |
| ASTR-03 | Phase 2 | Complete |
| ASTR-04 | Phase 2 | Complete |
| ASTR-05 | Phase 2 | Complete |
